...
public enum CRATESTATE_dup2
{
    MOVING,
    DEAD
}

public class CrateController_dup2 : MonoBehaviour
{
    static public CrateController_dup2 instance;
    ...
    private CRATESTATE_dup2 crateState = CRATESTATE_dup2.MOVING;
    ...
    private void Respawn()
    {
        ...
        crateState = CRATESTATE_dup2.MOVING;
    }
    ...
    public void DestroyCrate()
    {
        ...
        crateState = CRATESTATE_dup2.DEAD;
    }
    ...
    public CRATESTATE_dup2 GetCrateState()
    {
        return crateState;
    }
}
